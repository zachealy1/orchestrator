...
describe("sidebar history controller", () => {
  ...
  it("queries Priority without expanding workspaces, refreshes on activity and focus, and expires exactly at 7 days", async () => {
    vi.useFakeTimers();
      ...
      listPriority: vi.fn(async () => [
        {
          ...
          latest_finished_at: "2026-09-05T12:00:01Z",
