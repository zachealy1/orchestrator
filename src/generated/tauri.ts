...
export const commands = {
	...
	appUpdateDownload: () => __TAURI_INVOKE<AppUpdateState>("app_update_download"),
	appUpdateInstall: () => __TAURI_INVOKE<AppUpdateState>("app_update_install"),
	...
	runPreflight: (path: string, prompt: string) => __TAURI_INVOKE<PreflightReport>("run_preflight", { path, prompt }),
