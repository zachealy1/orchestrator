...
vi.mock("../features/kanban/api", async () => {
  ...
  return {
    ...
    createKanbanCard: mocks.createKanbanCardMock,
...
export function prepareDefaults() {
  ...
  mocks.createKanbanCardMock.mockImplementation(async (workspaceId, draft) => ({
    id: "card-created-from-composer",
    workspaceId,
    chatId: 778,
    title: draft.title,
    ...
    executionSettingsJson: draft.executionSettingsJson,
  ...
  mocks.readBrowserRuntimeStatusMock.mockResolvedValue({
    status: "available",
    message: "Browser tools are available for this account.",
  });
