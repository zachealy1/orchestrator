...
| Installation activity | Stable UUID, daily UTC deduplication, offline retries, opt-out cancellation, public release configuration | Native/frontend tests passed; live test-project ingestion and dashboard tiles pending |
